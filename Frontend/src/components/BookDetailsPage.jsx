...
import { Globe, PackageCheck, Tag, TagIcon } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="grid md:grid-cols-2 gap-14">
        ...
        <div className="flex flex-col justify-between">
          ...
          {/* Extra Info */}
          <div
            className="relative bg-white/80 backdrop-blur-md border border-gray-200 
rounded-3xl p-7 mb-10 shadow-xl hover:shadow-2xl 
transition-all duration-500 overflow-hidden"
          ...
          <div className="flex gap-4">
            ...
            <button className="px-6 py-4 rounded-2xl border border-gray-300 hover:bg-gray-100 transition">
              ❤️ Wishlist
            </button>
          </div>
        </div>
